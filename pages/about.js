...
export default function About() {
  return (
    <div>
      ...
      <div className="bg-gray-100 shadow my-4 py-6 md:flex">
        <div className="px-5 max-w-xl shadow-lg bg-gray-200 hover:shadow-inner hover:bg-gray-300 transition duration-500 ease-in-out">
